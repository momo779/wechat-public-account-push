export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx9ee3648f8cd514a5
",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "13be3764b1af06e58bdb9f00857ec86b
",
  ...
  USERS: [
    {
      ...
      id: "oUZC46FY1DwLkAksMw2h3jj0S0zs",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "	rUggzCeA9o1K4H78HfSSNAjek_2Lcty9Wpda5sbFfZk	",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "肇庆",
